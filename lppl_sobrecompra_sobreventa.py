...
def generar_grafico_lppl(path, ticker, fecha_inicio=fecha_inicio, fecha_fin=fecha_fin):
    ...
    plt.plot(spy['Date'], log_price, label='Log Precio '+ticker, color='blue')
...
def generar_grafico_lppl_sobre(path, ticker, fecha_inicio=fecha_inicio, fecha_fin=fecha_fin):
    # === Descargar datos ===    
    ...
    # Precio real
    ax1.plot(data['Date'], data['LogClose'], color='blue', label='Precio')
...
def generar_graficos(path):
    ...
    generar_grafico_lppl(path+'/lppl_spy.png', ticker='SPY', fecha_inicio=fecha_inicio, fecha_fin=fecha_fin)
    generar_grafico_lppl(path+'/lppl_qqq.png', ticker='QQQ', fecha_inicio=fecha_inicio, fecha_fin=fecha_fin)

    generar_grafico_lppl_sobre(path+'/lppl_spy_sobre.png', ticker='SPY', fecha_inicio=fecha_inicio, fecha_fin=fecha_fin)
    generar_grafico_lppl_sobre(path+'/lppl_qqq_sobre.png', ticker='QQQ', fecha_inicio=fecha_inicio, fecha_fin=fecha_fin)
